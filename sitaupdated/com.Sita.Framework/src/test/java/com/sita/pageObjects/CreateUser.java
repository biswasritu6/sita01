...
public class CreateUser extends WebdriverUtility{
		...
		@FindBy(id="control-hooks_fullName") WebElement Name;
		
		@FindBy(id="control-hooks_employeeId") WebElement employeeCode;
		
		@FindBy(id="control-hooks_email") WebElement email;
		
		@FindBy(id="control-hooks_phoneNumber") WebElement phNumber;
